...
filter_blood_data <- function(df) {
  ...
  # In R, functions generally return new objects, so explicit copy is often not needed
  # if you're assigning the result, but `df_labeled <- df` creates a shallow copy
  # of the data frame structure, and modifications to columns will create new vectors.
  df_labeled <- df
